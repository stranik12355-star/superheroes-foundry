  ...
  activateListeners(html){
    ...
    html.on("click.superheroes","[data-action]",async e=>{
      ...
      try{
        ...
        if(a==="add-list-item")return this._addInlineListItem(el.dataset.type);
        if(a==="edit-list-item")return this._editInlineListItem(el.dataset.type,Number(el.dataset.index));
        if(a==="save-list-item")return this._saveInlineListItem(el.closest("[data-inline-editor]"));
        if(a==="cancel-list-item")return this._cancelInlineListItem(el.closest("[data-inline-editor]"));
